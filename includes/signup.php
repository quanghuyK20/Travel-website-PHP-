			...
			<section>
				<div class="modal-body modal-spa">
					<div class="login-grids">
						<div class="login">
							...
							<div class="login-right">
								<form name="signup" method="post">
									<h3>Đăng kí</h3>
									<input type="text" value="" placeholder="Tên nguời dung" name="fname" autocomplete="off" required="">
						...
						<p>Bằng cách đăng kí, bạn đồng ý với <a href="page.php?type=terms">Các điều khoản và điều kiện</a> và <a href="page.php?type=privacy">Chính sách bảo mật</a></p>
					</div>
				</div>
			</section>
		</div>
