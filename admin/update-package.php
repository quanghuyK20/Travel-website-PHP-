	...
	<body>
		<div class="page-container">
			...
			<div class="left-content">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="manage-packages.php">Manage Packages</a><i class="fa fa-angle-right"></i>Update Tour Package </li>
				</ol>
				<!--grid-->
				<div class="grid-form">
									...
									foreach ($results as $result) {	?>
										...
										<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<img src="pacakgeimages/<?php echo htmlentities($result->img1); ?>" width="200">&nbsp;&nbsp;&nbsp;<a href="change-image.php?imgid1=<?php echo htmlentities($result->PackageId); ?>">Change Image 1</a>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<img src="pacakgeimages/<?php echo htmlentities($result->img2); ?>" width="200">&nbsp;&nbsp;&nbsp;<a href="change-image.php?imgid2=<?php echo htmlentities($result->PackageId); ?>">Change Image 2</a>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<img src="pacakgeimages/<?php echo htmlentities($result->img3); ?>" width="200">&nbsp;&nbsp;&nbsp;<a href="change-image.php?imgid3=<?php echo htmlentities($result->PackageId); ?>">Change Image 3</a>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<img src="pacakgeimages/<?php echo htmlentities($result->img4); ?>" width="200">&nbsp;&nbsp;&nbsp;<a href="change-image.php?imgid4=<?php echo htmlentities($result->PackageId); ?>">Change Image 4</a>
												</div>
											</div>
