...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "update tblview set viewimage=:vimage where vid=:imgid";
    ...
    <body>
        <div class="page-container">
            ...
            <div class="left-content">
                ...
                <!--heder end here-->
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="update-view.php">Update</a><i class="fa fa-angle-right"></i>Update Image </li>
                </ol>
                <!--grid-->
                <div class="grid-form">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="horizontal-form">
                                <form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
                                    <?php
                                    $imgid = intval($_GET['imgid']);
                                    $sql = "SELECT viewimage from tblview where vid=:imgid";
                                    $query = $dbh->prepare($sql);
                                    $query->bindParam(':imgid', $imgid, PDO::PARAM_STR);
                                    $query->execute();
                                    ...
                                    if ($query->rowCount() > 0) {
                                        foreach ($results as $result) {    ?>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <img src="pacakgeimages/<?php echo htmlentities($result->viewimage); ?>" width="200">
                                                </div>
                                            </div>
