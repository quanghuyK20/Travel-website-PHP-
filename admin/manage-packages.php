									...
									if ($query->rowCount() > 0) {
										foreach ($results as $result) {				?>
											<tr>
												...
												<td><a href="manage-packages.php?peid=<?php echo htmlentities($result->PackageId); ?>"><button type="submit1" name="submit1" class="btn btn-primary btn-block" style="background-color: #DF3A01;" onclick="return confirm('Bạn muốn xóa thông tin ?')">Delete Details</button></a></td>
											</tr>
									<?php $cnt = $cnt + 1;
										}
									} ?>
