...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO tbltienich(tieude,noidung) VALUES(:tieude,:noidung)";
                            ...
                            <div class="tab-pane active" id="horizontal-form">
                                <form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control1" name="tieude" id="tieude" placeholder="Nhập mô tả" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="focusedinput" class="col-sm-2 control-label">Nội dung chính</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control1" name="noidung" id="noidung" placeholder="Nhập mô tả" required>
                                        </div>
                                    </div>
