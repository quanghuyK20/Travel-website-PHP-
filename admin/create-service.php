...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO tblservice(namesv,svcontent) VALUES(:iname,:icontent)";
        // $sql1 = "INSERT INTO tblnew(nameidea,content,imagenew) VALUES(:inew,:infor,:vimage)";
        $query = $dbh->prepare($sql);
        // $query1 = $dbh->prepare($sql1);

        $query->bindParam(':iname', $iname, PDO::PARAM_STR);
        $query->bindParam(':icontent', $icontent, PDO::PARAM_STR);
        // $query1->bindParam(':inew', $inew, PDO::PARAM_STR);
        // $query1->bindParam(':infor', $infor, PDO::PARAM_STR);
        // $query1->bindParam(':vimage', $vimage, PDO::PARAM_STR);
        $query->execute();
        // $query1->execute();
                        ...
                        <div class="tab-pane active" id="horizontal-form">
                            <form class="form-horizontal" name="view" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" name="namesv" id="namesv" placeholder="Create image" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="focusedinput" class="col-sm-2 control-label">Chi tiết</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" name="svcontent" id="svcontent" placeholder="Create Infor" required>
                                    </div>
                                </div>
                                ...
                                <!-- <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" name="svnew" id="svnew" placeholder="Thêm mô tả" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" name="newinfor" id="newinfor" placeholder="Thêm mô tả" required>
                                    </div>
                                </div>
