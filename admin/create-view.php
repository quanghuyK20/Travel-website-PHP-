...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO tblview(imagename,viewinfor,mt1,mt2,mt3,viewimage) VALUES(:iname,:itype,:itype1,:itype2,:itype3,:vimage)";
...
<head>
    <title>TMS | Admin View Creation</title>
        ...
        <div class="left-content">
            ...
            <div class="grid-form">
                ...
                <div class="grid-form1">
                    <h3>Create Images View</h3>
                    <?php if ($error) { ?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } else if ($msg) { ?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php } ?>
                    <div class="tab-content">
                        <div class="tab-pane active" id="horizontal-form">
                            <form class="form-horizontal" name="view" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="focusedinput" class="col-sm-2 control-label">Image Name</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" name="imagename" id="imagename" placeholder="Create image" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="focusedinput" class="col-sm-2 control-label">Infor</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" name="viewinfor" id="viewinfor" placeholder="Create Infor" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" name="viewinfor1" id="viewinfor1" placeholder="Thêm mô tả" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" name="viewinfor2" id="viewinfor2" placeholder="Thêm mô tả" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" name="viewinfor3" id="viewinfor3" placeholder="Thêm mô tả" required>
                                    </div>
                                </div>
